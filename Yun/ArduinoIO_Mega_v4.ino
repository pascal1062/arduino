...
void loadCalibration() {
  int index = 0;
  File dataFileA = FileSystem.open("/mnt/sd/arduino/analogInCalib.txt", FILE_READ);
...
void loadScaleRangeAI1() {
  int index = 0;
  File dataFileB = FileSystem.open("/mnt/sd/arduino/scalerangeAI1.txt", FILE_READ);
...
void loadScaleRangeAI2() {
  int index = 0;
  File dataFileC = FileSystem.open("/mnt/sd/arduino/scalerangeAI2.txt", FILE_READ);
...
void loadScaleRangeAI3() {
  int index = 0;
  File dataFileD = FileSystem.open("/mnt/sd/arduino/scalerangeAI3.txt", FILE_READ);
...
void loadScaleRangeAI4() {
  int index = 0;
  File dataFileE = FileSystem.open("/mnt/sd/arduino/scalerangeAI4.txt", FILE_READ);
...
void loadScaleRangeAI5() {
  int index = 0;
  File dataFileF = FileSystem.open("/mnt/sd/arduino/scalerangeAI5.txt", FILE_READ);
...
void loadScaleRangeAI6() {
  int index = 0;
  File dataFileG = FileSystem.open("/mnt/sd/arduino/scalerangeAI6.txt", FILE_READ);
